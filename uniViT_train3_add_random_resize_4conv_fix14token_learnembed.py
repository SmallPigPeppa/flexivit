...
class ClassificationEvaluator(pl.LightningModule):
    ...
    def forward_features_afterembed(self, x: torch.Tensor) -> torch.Tensor:
    ...
    def forward_afterembed(self, x: torch.Tensor) -> torch.Tensor:
        x = self.forward_features_afterembed(x)
        x = self.forward_head(x)
        return x
    ...
    def rand_ms_embedding(self, x: torch.Tensor) -> torch.Tensor:
