...
class ClassificationEvaluator(pl.LightningModule):
    ...
    def ms_forward(self, x: torch.Tensor) -> torch.Tensor:
        x_4x4 = F.interpolate(x, size=28, mode='bilinear')
        x_4x4 = self.patch_embed_4x4(x_4x4, patch_size=2)

        x_8x8 = F.interpolate(x, size=56, mode='bilinear')
        x_8x8 = self.patch_embed_8x8(x_8x8, patch_size=4)

        x_12x12 = F.interpolate(x, size=112, mode='bilinear')
        x_12x12 = self.patch_embed_12x12(x_12x12, patch_size=8)
    ...
    def rand_ms_forward(self, x: torch.Tensor) -> torch.Tensor:
        ...
        token_num_4x4 = 14
        patch_size_4x4_0 = random.randint(2, 4)
        patch_size_4x4_1 = random.randint(2, 4)
        ...
        token_num_8x8 = 14
        patch_size_8x8_0 = random.randint(4, 8)
        patch_size_8x8_1 = random.randint(4, 8)
        ...
        token_num_12x12 = 14
        patch_size_12x12_0 = random.randint(8, 16)
        patch_size_12x12_1 = random.randint(8, 16)
        ...
        token_num_16x16 = 14
        patch_size_16x16_0 = random.randint(16, 32)
        patch_size_16x16_1 = random.randint(16, 32)
    ...
    def modified(self, new_image_size=224, new_patch_size=16):
        ...
        self.patch_embed_4x4 = self.get_new_patch_embed(new_image_size=28, new_patch_size=2)
        self.patch_embed_8x8 = self.get_new_patch_embed(new_image_size=56, new_patch_size=4)
        self.patch_embed_12x12 = self.get_new_patch_embed(new_image_size=112, new_patch_size=8)
...
if __name__ == "__main__":
    ...
    wandb_logger = WandbLogger(name='add-random-resize-4conv-fix14token-2481632-ratio', project='L2P',
                               entity='pigpeppa', offline=False)
    checkpoint_callback = ModelCheckpoint(monitor="val_acc_16x16", mode="max",
                                          dirpath='ckpt/L2P/add_random_resize_4conv_fix14token_2481632_ratio',
                                          save_top_k=1,
                                          save_last=True)
