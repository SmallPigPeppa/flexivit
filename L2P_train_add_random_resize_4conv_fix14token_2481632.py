...
class ClassificationEvaluator(pl.LightningModule):
    ...
    def rand_ms_forward(self, x: torch.Tensor) -> torch.Tensor:
        ...
        token_num_4x4 = 14
        patch_size_4x4 = random.randint(2, 4)
        ...
        token_num_8x8 = 14
        patch_size_8x8 = random.randint(4, 8)
        ...
        token_num_12x12 = 14
        patch_size_12x12 = random.randint(8, 16)
        ...
        token_num_16x16 = 14
        patch_size_16x16 = random.randint(16, 32)
...
if __name__ == "__main__":
    ...
    wandb_logger = WandbLogger(name='add-random-resize-4conv-fix14token-2481632', project='L2P',
                               entity='pigpeppa', offline=False)
    checkpoint_callback = ModelCheckpoint(monitor="val_acc_16x16", mode="max",
                                          dirpath='ckpt/L2P/add_random_resize_4conv_fix14token_2481632', save_top_k=1,
                                          save_last=True)
