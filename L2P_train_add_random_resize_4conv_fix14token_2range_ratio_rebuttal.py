...
class ClassificationEvaluator(pl.LightningModule):
    ...
    def ms_forward(self, x: torch.Tensor) -> torch.Tensor:
        x_4x4 = F.interpolate(x, size=560, mode='bilinear')
        x_4x4 = self.patch_embed_4x4(x_4x4, patch_size=4)

        x_8x8 = F.interpolate(x, size=896, mode='bilinear')
        x_8x8 = self.patch_embed_8x8(x_8x8, patch_size=8)

        x_12x12 = F.interpolate(x, size=1120, mode='bilinear')
    ...
    def rand_ms_forward(self, x: torch.Tensor) -> torch.Tensor:
        ...
        patch_size_12x12_0 = 80
        patch_size_12x12_1 = 80
        ...
        patch_size_16x16_0 = 16
        patch_size_16x16_1 = 16
    ...
    def modified(self, new_image_size=224, new_patch_size=16):
        ...
        self.patch_embed_4x4 = self.get_new_patch_embed(new_image_size=560, new_patch_size=40)
        self.patch_embed_8x8 = self.get_new_patch_embed(new_image_size=896, new_patch_size=64)
        self.patch_embed_12x12 = self.get_new_patch_embed(new_image_size=1120, new_patch_size=80)
...
if __name__ == "__main__":
    ...
    wandb_logger = WandbLogger(name='rebuttal_5608961120', project='L2P',
                               entity='pigpeppa', offline=False)
    checkpoint_callback = ModelCheckpoint(monitor="val_acc_16x16", mode="max",
                                          dirpath='ckpt/L2P/rebuttal_5608961120',
                                          save_top_k=1,
                                          save_last=True)
