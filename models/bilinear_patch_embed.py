...
class BilinearPatchEmbed(nn.Module):
    def __init__(
            self,
    ...
    def interpolate_resize_patch_embed(self,
            patch_embed: Tensor,
    ...
    def forward(
        ...
        if patch_size == self.patch_size:
            ...
            weight = self.interpolate_resize_patch_embed(self.proj.weight, patch_size)
...
if __name__ == '__main__':
    ...
    new_patch_embed = BilinearPatchEmbed(
