...
# x1, _ = m.patch_embed_3x3_s1(x, patch_size=3, stride=1)
# print(x1.shape)
# for i in [28, 42, 56]:
#     x = torch.rand(size=(1, 3, i, i))
#     x1, s1 = m.patch_embed_3x3_s1(x, patch_size=3, stride=1)
#     # print(x1.shape)
#
#     x2 = m.forward_after_patch_embed(x1, s1)
#     print(x2.shape)
