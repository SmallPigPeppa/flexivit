...
from models.flex_patch_embed_change_resize_mode import FlexiPatchEmbed
import random
...
class ClassificationEvaluator(pl.LightningModule):
    ...
    def rand_ms_forward(self, x: torch.Tensor) -> torch.Tensor:
        ...
        x_4x4 = self.patch_embed_4x4(x_4x4, patch_size=[patch_size_4x4_0, patch_size_4x4_1], mode=self.mode)
        ...
        x_8x8 = self.patch_embed_8x8(x_8x8, patch_size=[patch_size_8x8_0, patch_size_8x8_1], mode=self.mode)
        ...
        x_12x12 = self.patch_embed_12x12(x_12x12, patch_size=[patch_size_12x12_0, patch_size_12x12_1], mode=self.mode)
        ...
        x_16x16 = self.patch_embed_16x16(x_16x16, patch_size=[patch_size_16x16_0, patch_size_16x16_1], mode=self.mode)
