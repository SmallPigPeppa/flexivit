...
class ClassificationEvaluator(pl.LightningModule):
    ...
    def rand_ms_forward(self, x: torch.Tensor) -> torch.Tensor:
        ...
        token_num_8x8 = 14
        patch_size_8x8 = random.randint(5, 12)
        ...
        token_num_12x12 = 14
        patch_size_12x12 = random.randint(8, 18)
        ...
        token_num_16x16 = 14
        patch_size_16x16 = random.randint(10, 24)
...
if __name__ == "__main__":
    ...
    wandb_logger = WandbLogger(name='add-random-resize-4conv-fix14token-1.5range', project='L2P',
                               entity='pigpeppa', offline=False)
    checkpoint_callback = ModelCheckpoint(monitor="val_acc_16x16", mode="max",
                                          dirpath='ckpt/L2P/add_random_resize_4conv_fix14token_1.5range', save_top_k=1,
                                          save_last=True)
