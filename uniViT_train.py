...
class ClassificationEvaluator(pl.LightningModule):
    ...
    def training_step(self, batch, batch_idx):
        ...
        # out dict
        out_dict = {'train_loss': loss, 'train_acc': acc}
        # Log
...
if __name__ == "__main__":
    ...
    wandb_logger = WandbLogger(name='finetune-conv', project='uniViT', entity='pigpeppa', offline=False)
    ...
    for image_size, patch_size in [(224, 16)]:
        ...
        train_loader = DataLoader(val_dataset, batch_size=args.batch_size, num_workers=args.works,
                                  shuffle=False, pin_memory=True)
