...
if __name__ == "__main__":
    ...
    wandb_logger = WandbLogger(name='ft-part-conv-uniViT-no-random-resize-4conv-fixconv16', project='uniViT',
                               entity='pigpeppa', offline=False)
    checkpoint_callback = ModelCheckpoint(monitor="val_acc_16x16", mode="max",
                                          dirpath='ckpt/uniViT/no-random-resize-4conv-fixconv16', save_top_k=1,
                                          save_last=True)
